...
type BadgeColor = 'indigo' | 'emerald' | 'amber' | 'red' | 'sky' | 'gray' | 'purple' | 'violet' | 'yellow';
...
const colorMap: Record<BadgeColor, string> = {
  ...
  amber: 'bg-amber-500/20 text-amber-800 border-amber-800/60',
  ...
  yellow: 'bg-yellow-300/40 text-yellow-700 border-yellow-700',
};
